...
TOME = dict(NARR_SHARE=0.45, NARR_CHARS=(110, 300), NARR_BEATS=(8, 16),
            LEN_RANGE=(35, 60), DLG_MARKS=(4, 12), CUTS_PER_MIN=(35, 55),
...
NARR_BEAT_SECS = (2.5, 4.0)  # 한 마디 길이. ★딸기우유(1.8~3.2)보다 길다
...
TTS_VOICE = "tc_611c3f692fac944dff493a04"   # SeHee
TTS_TEMPO = 1.2
