...
for _r in rows:
    ...
    for _w in _M_PLACE:
        if _w in _nt:
            WARN.append(f"나레 '{_nt}' 에 장소 '{_w}' — 부록 M-14, 장소 설명은 그림에 맡기고 인물·행동만 말해라")
            break
...
if _sc.returncode != 0:
    ...
    print("  │   python presets/포레이로/synccheck.py " + os.path.basename(wd))
